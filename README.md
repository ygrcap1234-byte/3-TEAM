...
|---|---|---|---|---|---|
| <img src="https://github.com/ygrcap1234-byte.png?size=80" width="64" alt=""> | **김동규** | 로이 (ROY) | 팀 리드 · 개발<br>*The Mastermind* 두뇌 풀가동 담당 | "잠깐만요, 이거 방법 있을 것 같은데요?" | 노래 / 헬스 / 영화 |
...
| <img src="https://github.com/LimAhmadarif.png?size=80" width="64" alt=""> | **임아메드알리프** | 로사 (ROSA) | 개발 · 리서치<br>*The Refiner* 아이디어 진화 담당 | "좋아요. 그럼 더 좋게 바꿔볼게요." | 드라마 / 축구 / 게임 |
...
- 이 저장소의 `index.html`은 과제 초기에 만든 첫 버전 랜딩 페이지입니다: https://ygrcap1234-byte.github.io/3-TEAM/
...
├── 회의록/                          # 날짜별 회의록 (YYYY.MM.DD-NN.md)
├── .github/ISSUE_TEMPLATE/task.md  # 작업 이슈 템플릿
├── my-first.md                     # Markdown 연습 파일
└── README.md
```

## 로드맵

### 과제 #3 — 팀 셋업 (2026-09-08 ~ 09-15) ✅ 완료

| 마일스톤 | 기한 | 이슈 |
|---|---|---|
| 프로젝트 협업 환경 구축 | 09-14 | [#19 깃 숙지](../../issues/19) · [#20 간반보드 개설](../../issues/20) · [#21 마일스톤 개설](../../issues/21) |
| README & 랜딩페이지 완성 | 09-14 | [#22 README.md 작성](../../issues/22) · [#23 구조 짜기](../../issues/23) · [#24 랜딩페이지 제작](../../issues/24) · [#25 영상 제작](../../issues/25) · [#26 구체화](../../issues/26) |
| 과제 #3 최종 제출 & 발표 | 09-15 | [#27 제출 및 3분 발표 준비](../../issues/27) |
